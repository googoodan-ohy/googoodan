...
function menu(){
 ...
 groups.innerHTML='';
 const controls=document.createElement('nav');controls.className='edition-tabs';controls.setAttribute('aria-label','Worksheet sections');controls.innerHTML='<a href="/en/" aria-current="page">All arithmetic</a><a href="/en/levels.html">Practice by level</a><a href="/en/grades.html">US curriculum</a>';groups.append(controls);
