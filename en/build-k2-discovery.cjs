...
const relatedActivitySections = {
  ...
  'subtract-small.html': '<section class="seo-resource"><h2>See subtraction with pictures and number lines</h2><ul class="cards"><li><a href="/en/picture-subtraction.html">Picture subtraction worksheets</a></li><li><a href="/en/number-line-subtraction.html">Number line subtraction worksheets</a></li><li><a href="/en/fact-family-houses.html">Related addition and subtraction facts</a></li><li><a href="/en/subtraction-color-by-number.html">Subtraction color by number</a></li><li><a href="/en/make-10-subtraction.html">Make 10 subtraction worksheets</a></li></ul></section>',
  ...
  'word-problems.html': '<section class="seo-resource"><h2>Model and choose operations in word problems</h2><ul class="cards"><li><a href="/en/tape-diagram-word-problems.html">Tape diagram word problems</a></li><li><a href="/en/choose-operation-word-problems.html">Choose the operation word problems</a></li></ul></section>'
};
