...
const specs=[["K","within5","Combine and separate numbers within 5","EYFS · Number","early",5,null],["K","within10","Combine and separate numbers within 10","EYFS · Number","early",10,null],["K","make10","Number bonds to 10","EYFS · Number","bond",10,null],];const add=(y,id,name,kind,a,b)=>specs.push([y,id,name,'Year '+y,kind,a,b]);
...
root.GDCurriculumConfig={prefix:'eng',yearLabel:'Year',grades:['K',1,2,3,4,5,6],gradeLabels:{K:'Reception'},earlyYearsSource:'https://www.gov.uk/government/publications/development-matters--2/development-matters',title:'England curriculum arithmetic',referenceLabel:'National curriculum',source,specs,
