...
if(['add','sub','unknown','three'].includes(kind)){
 ...
 else if(kind==='symmetry-line')finish('正方形の대칭축はいくつですか。',poly(4),4,'마주 보は 변の중점を잇は 2개와 対角線 2個です。');
