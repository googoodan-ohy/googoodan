...
if(['add','sub','unknown','three'].includes(kind)){
 ...
 else {const n=between(3,8);if(kind==='diagonal')finish('한 頂点の그を수 있は 対角線はいくつですか。',poly(n),n-3,'자기 자신と이웃한 두 頂点を제외します。');else finish('다각형の변はいくつですか。',poly(n),n,'둘레를 따라 변を하나씩 셉니다.')}
}
