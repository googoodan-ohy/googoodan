globalThis.JaCoreCatalog={"units":[{"id":"1-1-2","grade":1,"skills":["solid-basic","solid-sort","solid-basic"]},{"id":"1-1-3","grade":1,"skills":["add:9","sub:9","bond:9"]},{"id":"1-1-4","grade":1,"skills":["length-compare","area-compare","capacity-compare","weight-compare"]},{"id":"1-1-5","grade":1,"skills":["number:50","place:2","compare:50","sequence:50"]},{"id":"1-2-1","grade":1,"skills":["number:100","place:2","compare:100","sequence:100"]},{"id":"1-2-3","grade":1,"skills":["flat-basic","flat-count","flat-build","clock:30"]},{"id":"1-2-5","grade":1,"skills":["pattern","sequence:100","array-pattern"]},{"id":"2-1-1","grade":2,"skills":["place:3","number:999","compare:999","sequence:999"]},{"id":"2-1-2","grade":2,"skills":["flat-basic","flat-count","cube-count"]},{"id":"2-1-3","grade":2,"skills":["add:99","sub:99","three:20","unknown:99"]},{"id":"2-1-4","grade":2,"skills":["ruler:cm","measure:cm","length-compare"]},{"id":"2-1-5","grade":2,"skills":["sort","table","sort"]},{"id":"2-1-6","grade":2,"skills":["groups","mul:9","array"]},{"id":"2-2-1","grade":2,"skills":["place:4","number:9999","compare:9999","sequence:9999"]},{"id":"2-2-3","grade":2,"skills":["convert:m","measure-add:m","ruler:cm"]},{"id":"2-2-4","grade":2,"skills":["clock:5","elapsed","calendar"]},{"id":"2-2-5","grade":2,"skills":["table","graph:picture","sort"]},{"id":"2-2-6","grade":2,"skills":["pattern","sequence:100","array-pattern"]},{"id":"3-1-1","grade":3,"skills":["add:999","sub:999","unknown:999"]},{"id":"3-1-2","grade":3,"skills":["angle-right","flat-count"]},{"id":"3-1-3","grade":3,"skills":["div:9","groups-div","inverse"]},{"id":"3-1-4","grade":3,"skills":["mul:99","array","unknown-mul"]},{"id":"3-1-5","grade":3,"skills":["convert:mm","convert:km","clock:1","time-seconds"]},{"id":"3-1-6","grade":3,"skills":["fraction-model","fraction-compare","decimal-model","decimal-compare:1"]},{"id":"3-2-1","grade":3,"skills":["mul:999","mul-two","unknown-mul"]},{"id":"3-2-2","grade":3,"skills":["circle-parts","circle-size","circle-draw"]},{"id":"3-2-3","grade":3,"skills":["div:99","div-remainder","inverse"]},{"id":"3-2-4","grade":3,"skills":["convert:L","convert:kg","convert:t","measure-add:L","measure-add:kg"]},{"id":"3-2-5","grade":3,"skills":["fraction-model","fraction-form","fraction-compare"]},{"id":"3-2-6","grade":3,"skills":["graph:picture","table","graph:picture"]},{"id":"4-1-1","grade":4,"skills":["place:8","large-number","compare:99999999","sequence:99999999"]},{"id":"4-1-2","grade":4,"skills":["angle-measure","angle-sum","triangle-angle","quad-angle"]},{"id":"4-1-3","grade":4,"skills":["mul-two","div-two","inverse"]},{"id":"4-1-5","grade":4,"skills":["graph:bar","table","graph:bar"]},{"id":"4-1-6","grade":4,"skills":["sequence:999","array-pattern","equal","pattern"]},{"id":"4-2-1","grade":4,"skills":["fraction-add-same","fraction-sub-same","fraction-mixed-same"]},{"id":"4-2-3","grade":4,"skills":["decimal-add","decimal-sub","decimal-compare:3","decimal-place"]},{"id":"4-2-4","grade":4,"skills":["quad-type","parallel","quad-angle"]},{"id":"4-2-5","grade":4,"skills":["graph:line","graph:line","table"]},{"id":"4-2-6","grade":4,"skills":["polygon","diagonal","tile"]},{"id":"5-1-1","grade":5,"skills":["mixed","mixed-bracket","mixed-story"]},{"id":"5-1-2","grade":5,"skills":["factor","multiple","gcd","lcm"]},{"id":"5-1-3","grade":5,"skills":["correspond","correspond","equal"]},{"id":"5-1-5","grade":5,"skills":["fraction-add","fraction-sub","fraction-mixed"]},{"id":"5-1-6","grade":5,"skills":["perimeter","area-rectangle","area-triangle","area-parallelogram","area-trapezoid","area-rhombus"]},{"id":"5-2-1","grade":5,"skills":["range","round-up","round-down","round-nearest"]},{"id":"5-2-2","grade":5,"skills":["fraction-mul-whole","fraction-mul","fraction-mul-mixed"]},{"id":"5-2-3","grade":5,"skills":["congruent","symmetry-line","symmetry-point"]},{"id":"5-2-4","grade":5,"skills":["decimal-mul-whole","decimal-mul","decimal-scale"]},{"id":"5-2-5","grade":5,"skills":["cuboid","cube-net","cuboid-edges"]},{"id":"5-2-6","grade":5,"skills":["average","average-missing"]},{"id":"6-1-1","grade":6,"skills":["fraction-div-whole","whole-div-fraction-result","fraction-div-whole"]},{"id":"6-1-3","grade":6,"skills":["decimal-div-whole","decimal-fraction","decimal-div-whole"]},{"id":"6-1-4","grade":6,"skills":["ratio","percent","ratio-compare"]},{"id":"6-1-5","grade":6,"skills":["graph:strip","graph:pie","graph-choice"]},{"id":"6-1-6","grade":6,"skills":["volume","volume-convert"]},{"id":"6-2-1","grade":6,"skills":["fraction-div","whole-div-fraction","fraction-div-mixed"]},{"id":"6-2-2","grade":6,"skills":["cube-count","cube-view","cube-missing"]},{"id":"6-2-3","grade":6,"skills":["decimal-div","decimal-div","decimal-fraction"]},{"id":"6-2-4","grade":6,"skills":["proportion","share-ratio","ratio-simplify"]},{"id":"6-2-5","grade":6,"skills":["circle-circumference","circle-area","circle-half"]},{"id":"6-2-6","grade":6,"skills":["cylinder","cylinder-net"]}],"modeNames":["計算","選択","確かめ","文章題","説明"]};
(function(root){
...
if(['add','sub','unknown','three'].includes(kind)){
 ...
 else {const n=between(3,8);if(kind==='diagonal')finish('一つの頂点から引ける対角線は何本ですか。',poly(n),n-3,'その頂点自身と、隣り合う二つの頂点を除きます。');else finish('多角形の辺は何本ですか。',poly(n),n,'周りに沿って辺を一本ずつ数えます。')}
}
 ...
 visual='<div class="height-map">'+hs.map(n=>'<span>'+n+'</span>').join('')+'</div><small class="diagram-note">上から見た図・数字はその位置の積み木の数・下側が正面</small>';
 if(u.grade===2){const n=between(2,5);visual=svg(Array.from({length:n},(_,i)=>'<g transform="translate('+(i*29)+' 0)"><path d="M8 30L20 20H43V43L31 53H8ZM8 30H31L43 20M31 30V53" fill="#d9eaf3" stroke="#608397"/></g>').join(''),n*29+20,65);finish('積み木は全部で何個ですか。',visual,n,'並んでいる積み木を一つずつ数えます。')}
...
'fraction-div-whole':'分数を整数でわる','whole-div-fraction-result':'商を分数で表す',prism:'각기둥의 구성',pyramid:'각뿔의 구성','prism-net':'전개도로 입체 찾기','decimal-div-whole':'小数を整数でわる','decimal-fraction':'分数と小数',ratio:'比で表す',percent:'百分率を求める','ratio-compare':'割合を比べる','graph-choice':'グラフを選ぶ',surface:'직육면체의 겉넓이',volume:'直方体の体積','volume-convert':'体積の単位を変える',
