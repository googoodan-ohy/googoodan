globalThis.JaCoreCatalog={"units":[{"id":"1-1-2","grade":1,"skills":["solid-basic","solid-sort","solid-basic"]},{"id":"1-1-3","grade":1,"skills":["add:9","sub:9","bond:9"]},{"id":"1-1-4","grade":1,"skills":["length-compare","area-compare","capacity-compare","weight-compare"]},{"id":"1-1-5","grade":1,"skills":["number:50","place:2","compare:50","sequence:50"]},{"id":"1-2-1","grade":1,"skills":["number:100","place:2","compare:100","sequence:100"]},{"id":"1-2-3","grade":1,"skills":["flat-basic","flat-count","flat-build","clock:30"]},{"id":"1-2-5","grade":1,"skills":["pattern","sequence:100","array-pattern"]},{"id":"2-1-1","grade":2,"skills":["place:3","number:999","compare:999","sequence:999"]},{"id":"2-1-3","grade":2,"skills":["add:99","sub:99","three:20","unknown:99"]},{"id":"2-1-4","grade":2,"skills":["ruler:cm","measure:cm","length-compare"]},{"id":"2-1-5","grade":2,"skills":["sort","table","sort"]},{"id":"2-1-6","grade":2,"skills":["groups","mul:9","array"]},{"id":"2-2-1","grade":2,"skills":["place:4","number:9999","compare:9999","sequence:9999"]},{"id":"2-2-3","grade":2,"skills":["convert:m","measure-add:m","ruler:cm"]},{"id":"2-2-4","grade":2,"skills":["clock:5","elapsed","calendar"]},{"id":"2-2-5","grade":2,"skills":["table","graph:picture","sort"]},{"id":"2-2-6","grade":2,"skills":["pattern","sequence:100","array-pattern"]},{"id":"3-1-1","grade":3,"skills":["add:999","sub:999","unknown:999"]},{"id":"3-1-3","grade":3,"skills":["div:9","groups-div","inverse"]},{"id":"3-1-4","grade":3,"skills":["mul:99","array","unknown-mul"]},{"id":"3-1-5","grade":3,"skills":["convert:mm","convert:km","clock:1","time-seconds"]},{"id":"3-1-6","grade":3,"skills":["fraction-model","fraction-compare","decimal-model","decimal-compare:1"]},{"id":"3-2-1","grade":3,"skills":["mul:999","mul-two","unknown-mul"]},{"id":"3-2-3","grade":3,"skills":["div:99","div-remainder","inverse"]},{"id":"3-2-4","grade":3,"skills":["convert:L","convert:kg","convert:t","measure-add:L","measure-add:kg"]},{"id":"3-2-5","grade":3,"skills":["fraction-model","fraction-form","fraction-compare"]},{"id":"3-2-6","grade":3,"skills":["graph:picture","table","graph:picture"]},{"id":"4-1-1","grade":4,"skills":["place:8","large-number","compare:99999999","sequence:99999999"]},{"id":"4-1-3","grade":4,"skills":["mul-two","div-two","inverse"]},{"id":"4-1-5","grade":4,"skills":["graph:bar","table","graph:bar"]},{"id":"4-2-1","grade":4,"skills":["fraction-add-same","fraction-sub-same","fraction-mixed-same"]},{"id":"4-2-3","grade":4,"skills":["decimal-add","decimal-sub","decimal-compare:3","decimal-place"]},{"id":"4-2-5","grade":4,"skills":["graph:line","graph:line","table"]},{"id":"5-1-1","grade":5,"skills":["mixed","mixed-bracket","mixed-story"]},{"id":"5-1-2","grade":5,"skills":["factor","multiple","gcd","lcm"]},{"id":"5-1-3","grade":5,"skills":["correspond","correspond","equal"]},{"id":"5-1-5","grade":5,"skills":["fraction-add","fraction-sub","fraction-mixed"]},{"id":"5-2-1","grade":5,"skills":["range","round-up","round-down","round-nearest"]},{"id":"5-2-2","grade":5,"skills":["fraction-mul-whole","fraction-mul","fraction-mul-mixed"]},{"id":"5-2-4","grade":5,"skills":["decimal-mul-whole","decimal-mul","decimal-scale"]},{"id":"6-1-1","grade":6,"skills":["fraction-div-whole","whole-div-fraction-result","fraction-div-whole"]},{"id":"6-1-3","grade":6,"skills":["decimal-div-whole","decimal-fraction","decimal-div-whole"]},{"id":"6-1-5","grade":6,"skills":["graph:strip","graph:pie","graph-choice"]},{"id":"6-2-1","grade":6,"skills":["fraction-div","whole-div-fraction","fraction-div-mixed"]},{"id":"6-2-3","grade":6,"skills":["decimal-div","decimal-div","decimal-fraction"]}],"modeNames":["計算","選択","確かめ","文章題","説明"]};
(function(root){
...
function calc(x,y,op,opts={}){
 ...
 finish('計算しましょう。',opts.art||'',value,expr+' = '+value,{wrong:fmt(result+1),story:op==='+'?'구슬 '+fmt(x)+'개に'+fmt(y)+'개를 더 넣었습니다. 모두何개ですか。':op==='−'?'색종が'+fmt(x)+'장 중 '+fmt(y)+'장を썼습니다.何장が남았나요?':op==='×'?'한 묶음に'+fmt(x)+'こずつ'+fmt(y)+'묶음です。 모두何개ですか。':fmt(x)+'개를 '+fmt(y)+'人에게 똑같が나누면 한 人이何개를 받나요?'});
...
if(['add','sub','unknown','three'].includes(kind)){
 ...
 else if(kind==='chance'){const ans=pick(['불가능하다','확실하다','반반이다']),stem=ans==='불가능하다'?'빨간 공만 있は 상자の파란 공を뽑を가능성은 어떤가요?':ans==='확실하다'?'파란 공만 있は 상자の파란 공を뽑を가능성은 어떤가요?':'빨간 공 1개와 파란 공 1개 중 보지 않고 하나를 뽑を때 빨간 공日目 가능성은 어떤가요?';finish(stem,'',ans,'상자 안の공 종류와 개수를 비교します。',{choices:['불가능하다','확실하다','반반이다'],wrong:ans==='확실하다'?'불가능하다':'확실하다'})}
 else {a=between(5,15);b=between(1,4);const vals=[a-b,a,a+b];if(kind==='average')finish('세 수の평균を求めましょう.','<div class="kequation">'+vals.join(', ')+'</div>',a,'합 '+a*3+'を자료 수 3으로 나눕니다.');else finish('평균が'+a+'日目 때 □를 求めましょう.','<div class="kequation">'+(a-b)+', □, '+(a+b)+'</div>',a,'합 '+a*3+'の알려진 두 수를 뺍니다.')}
}
 ...
 else if(kind==='cube-net'){const cells=[[1,0],[0,1],[1,1],[2,1],[3,1],[1,2]],idx=r(6);visual=svg(cells.map(([x,y],i)=>'<rect x="'+(30+x*24)+'" y="'+(5+y*24)+'" width="24" height="24" fill="'+(i===idx?'#efca80':'#e7eff5')+'" stroke="#64879a"/>').join(''),170,85);finish('정육면체 전개도の색칠하지 않은 면은何개ですか。',visual,5,'정四角形 6개 중 색칠한 1개를 빼면 5個です。');if(mode===4){prompt='が전개도를 접어 정육면체가 되は 까닭を설人하세요.';answer='6개の정四角形が겹치지 않고 정육면체の6개 면を만듭니다.';reason='직접 오려 접어 확인해도 좋습니다.'}}
...
'fraction-div-whole':'分数を整数でわる','whole-div-fraction-result':'商を分数で表す',prism:'각기둥의 구성',pyramid:'각뿔의 구성','prism-net':'전개도로 입체 찾기','decimal-div-whole':'小数を整数でわる','decimal-fraction':'分数と小数',ratio:'비로 나타내기',percent:'백분율 구하기','ratio-compare':'비율 비교','graph-choice':'グラフを選ぶ',surface:'직육면체의 겉넓이',volume:'직육면체의 부피','volume-convert':'부피 単位を変える',
