...
if(['add','sub','unknown','three'].includes(kind)){
 ...
 else if(kind==='volume'){result=a*b*c;stem='横 '+a+' cm, 縦 '+b+' cm, 高さ '+c+'cmの直方体の부피は何cm³ですか。';art=cubeArt();why='横 × 縦 × 高さ'}
