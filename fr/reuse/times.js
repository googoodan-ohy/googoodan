...
let prompt='',visual='',task=blank,answer='',reason='',open=false,check={kind:'times',a,b,product,method};
  ...
  if(['story','family','team','pack','ticket','reverse','choose'].includes(method)){
   ...
   const contextsByArt=[
 ['Chaque famille compte '+a+' animaux comme celui du dessin. Il y a '+b+(b===1?' famille.':' familles.')+'','Combien y a-t-il d’animaux en tout?',product+' animaux forment des familles de '+a+'. Combien de familles?',' animaux'],
 ['Chaque groupe reçoit '+a+' objets comme celui du dessin. Il y a '+b+(b===1?' groupe.':' groupes.')+'','Combien faut-il d’objets en tout?',product+' objets sont partagés en groupes de '+a+'. Combien de groupes?',' objets'],
 ['Chaque boîte contient '+a+' jouets comme celui du dessin. Il y a '+b+(b===1?' boîte.':' boîtes.')+'','Combien y a-t-il de jouets en tout?',product+' jouets sont rangés par '+a+' dans chaque boîte. Combien de boîtes?',' jouets'],
 ['On place '+a+' véhicules miniatures par rangée. Il y a '+b+(b===1?' rangée.':' rangées.')+'','Combien y a-t-il de véhicules en tout?',product+' véhicules sont placés par rangées de '+a+'. Combien de rangées?',' véhicules'],
 ['Chaque plateau contient '+a+' aliments comme celui du dessin. Il y a '+b+(b===1?' plateau.':' plateaux.')+'','Combien y a-t-il d’aliments en tout?',product+' aliments sont répartis par '+a+' sur chaque plateau. Combien de plateaux?',' aliments'],
 ['Chaque feuille porte '+a+' autocollants comme celui du dessin. Il y a '+b+(b===1?' feuille.':' feuilles.')+'','Combien y a-t-il d’autocollants en tout?',product+' autocollants sont répartis par '+a+' sur chaque feuille. Combien de feuilles?',' autocollants']
 ];
