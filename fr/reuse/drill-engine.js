...
[`Quel nombre dépasse ${a} de ${b} ?`,c,`${a} + ${b} = ${c}`],
[`Combien faut-il ajouter à ${a} pour obtenir ${c} ?`,b,`${c} − ${a} = ${b}`],
[`Quelle est la différence entre ${c} et ${b} ?`,a,`${c} − ${b} = ${a}`],
...
[`Une quantité de ${a} augmente de ${b}. Quelle est la nouvelle quantité ?`,c,`${a} + ${b} = ${c}`]];[prompt,answer,work]=items[form];}
