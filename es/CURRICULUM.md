...
## Same-denominator fraction drills — 2026-09-12
Added 14 unchanged profiles from Korean 4-2-1: eight basic addition/subtraction profiles, three prerequisite conversion reviews, two missing-number profiles and one word-problem profile. Mixed numbers are displayed as a whole-number part plus a fraction; original arithmetic and answers are preserved. Placement in grade 5 is editorial within Spain’s third-cycle fraction arithmetic, not a claim of identical sequencing across autonomous communities. Source: https://www.boe.es/buscar/act.php?id=BOE-A-2022-3296 (Annex II, Mathematics, third cycle). Source comparisons passed for 26,190 activity answers and 19,520 drill questions. All 14 browser routes and 28 one-page A4 PDFs passed. Spanish drills: 108 → 122; activities remain 97; HTML pages: 230 → 244.

## Fraction operations and prerequisites — 2026-09-12
Reused nine unchanged Korean 5-1-5 profiles: four basic fraction addition/subtraction profiles, two prerequisite reviews (simplification and common denominators), two missing-number profiles and one word-problem profile. Different-denominator proper-fraction drills reject equal denominators; mixed-number drills may use equal or different denominators. The story profile retains its original 27-profile pool, including natural numbers and proper, improper and mixed fractions. No calculation or answer logic was changed. A display-only mixed-number translation now distinguishes a mixed number from a pair of fractions in the common-denominator instruction.

Grade 5 placement is an editorial sequence within Spain’s third-cycle fraction arithmetic, not a claim that all autonomous communities use the same grade sequence. Source: https://www.boe.es/buscar/act.php?id=BOE-A-2022-3296 (Annex II, Mathematics, third cycle). Source comparisons passed for 26,190 activity answers and 20,960 drill questions. All nine browser routes, regeneration, answer modes and 18 one-page A4 PDFs passed. Spanish drills: 122 → 131; activities remain 97; HTML pages: 244 → 253.

## Fraction combinations and divisibility review — 2026-09-12
Added 27 unchanged Korean 5-1-5 profiles: 21 arithmetic variants involving natural numbers, proper and improper fractions and mixed numbers, plus six divisor/multiple reviews. Reversed addend orders are practice variants of the same concept, not additional curriculum objectives. Four other source profiles (1, 16, 37, 38) were excluded because their output matches existing Spanish same-denominator-unit profiles (2, 6, 0, 4): 9,600 of 9,600 question objects matched across 100 seeds. The new pages link directly to those existing reviews. The unit now offers 36 profiles and four linked existing equivalents, covering the 40 source profiles without four duplicate pages.

Placement remains an editorial grade-five sequence within the national third cycle, with divisibility as a prerequisite for equivalent fractions and arithmetic; it does not represent a completed autonomous-community curriculum map. Source: https://www.boe.es/buscar/act.php?id=BOE-A-2022-3296 (Annex II, Mathematics, third cycle). Calculation settings and source pools are preserved; six instructions are translated for display only. Source comparison passed for 26,190 activity answers and 25,280 drill questions. All 27 new desktop/mobile routes, regeneration and answer modes passed. All 54 question/answer PDFs fit one A4 page. Spanish drill profiles: 131 → 158; activities remain 97; HTML pages: 253 → 280.

## Order of operations and arithmetic review — 2026-09-13
Added all nine unchanged Korean 5-1-1 drill profiles: four calculation-order practices, four horizontal/vertical reviews of three-digit by two-digit multiplication/division, and one single-operation reading profile. The +×− practice does not claim to contain division; the story is explicitly described as choosing one operation, not a multistep word problem. Division review may have a remainder. Original generation settings, review fields and the four-source story pool remain unchanged. No new translation or calculation code was required.

Placement is grade 5 to match the existing Spanish order-of-operations and parentheses activities, rather than moving the same concept to grade 6 just to populate that menu. Reciprocal static links connect those two existing activities with these drills. This is an editorial sequence within the national third-cycle simple/combined operation objectives, not a completed regional curriculum map. Source: https://www.boe.es/buscar/act.php?id=BOE-A-2022-3296 (Annex II, Mathematics, third cycle). Validation: 26,190 activity answers and 26,720 drill questions match original generators. All nine desktop/mobile routes, regeneration and answer modes passed; all 18 question/answer PDFs fit one A4 page. Spanish drills: 158 → 167; activities remain 97; HTML pages: 280 → 289.

Next fraction-multiplication reuse needs a scope check: Korean 5-2-2 has six review duplicates and 17 remaining profiles, but its story generator adds fraction addition/subtraction to the multiplication pool. Do not label it multiplication-only; fractional quantities also need natural quantity wording rather than fractional counts of discrete objects.

## Grade-six fraction multiplication practice — 2026-09-13
Added 17 unchanged Korean 5-2-2 profiles: 15 product variants, a missing-factor/product profile and a varied fraction story profile. The six original prerequisite reviews match existing Spanish profiles (4,320 of 4,320 generated question objects in the audit), so the new pages link to those existing reviews rather than duplicate them. The menu begins with natural-number/fraction products before two-fraction and mixed-number variants. Reversed factors are practice variants of the same concept.

The original 15-profile story pool and Korean ID remain untouched. The source engine adds fraction addition/subtraction support at runtime, so the page describes products plus addition/subtraction relationships, without promising a fixed mix on every printed sheet. Fractional forward-group statements now refer to quantities per unit instead of fractional counts of discrete objects. The integer wording and all numeric fields, answers and work remain unchanged.

Grade-six placement matches the existing es-6-fracciones-por-naturales activity and provides an editorial extension within Spain’s third-cycle fraction arithmetic. This does not claim identical sequencing across autonomous communities or a complete sixth-grade curriculum. Source: https://www.boe.es/buscar/act.php?id=BOE-A-2022-3296 (Annex II, Mathematics, third cycle). Source comparison passed for 26,190 activity answers and 29,440 drill questions. All 17 desktop/mobile routes, regeneration and answer modes passed; the grade-six menu appears correctly. All 34 question/answer PDFs fit one A4 page. Spanish drill profiles: 167 → 184; activities remain 97; HTML pages: 289 → 306.

## Grade-six arithmetic menu — 2026-09-14
The sixth-course calculation menu now contains five visible units instead of falling back to course one: decimal addition/subtraction review (12 profiles), fraction addition/subtraction (32), fraction multiplication (17), decimal multiplication (18), and decimal division (17). The 79 added routes reuse existing Korean/Italian-derived profiles and shared calculation engines; no generator or answer logic changed. Grade-six arithmetic profiles: 17 → 96. Spanish drill profiles: 184 → 263; Spanish HTML pages: 306 → 385.

Placement is editorial within the national third-cycle objectives of [RD 157/2022](https://www.boe.es/buscar/act.php?id=BOE-A-2022-3296), not a completed autonomous-community sequence. Grade-five decimal addition/subtraction is explicitly labelled `Repaso`. Fraction tasks include four same-denominator profiles (addition, subtraction and two missing-number forms) before the natural/proper/improper/mixed-number combinations. Decimal multiplication and division cover whole numbers and values with one or two decimal places in horizontal and column layouts. Both include missing-number practice; only multiplication keeps the verified word-problem profile.

Validation: 26,190 activity answers and 42,080 drill questions match the original generators. All 385 Spanish pages pass unique-title, H1, canonical, JSON-LD, local-link and cache-version checks. Local Chrome verified all four same-denominator routes and all 35 decimal routes, including selection, regeneration-ready rendering and visible solutions, without runtime errors. Eight same-denominator question/answer PDFs and 14 representative decimal question/answer PDFs each fit one A4 page.
