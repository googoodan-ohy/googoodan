(function(root){const scope={Worksheets:{...root.Worksheets}};(function(globalThis){const Worksheets=globalThis.Worksheets;
(function(root){
...
})(scope);root.DrillEngine={gcd:scope.DrillEngine.gcd,lcm:scope.DrillEngine.lcm};})(globalThis);